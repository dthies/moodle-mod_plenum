...
/**
 * Cognitive depth indicator - plenum.
 *
 * @package   mod_plenum
...
namespace mod_plenum\analytics\indicator;
...
class cognitive_depth extends activity_base {
    ...
    public static function get_name(): \lang_string {
        return new \lang_string('indicator:cognitivedepth', 'mod_plenum');
    }
    ...
    protected function feedback_submitted_events() {
        return ['\mod_plenum\event\motion_created', '\mod_plenum\event\motion_updated'];
    }
