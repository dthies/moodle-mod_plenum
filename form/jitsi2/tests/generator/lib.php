 ...
 */
class plenumform_jitsi2_generator extends testing_module_generator {
    /**
     ...
     * @return motion
     */
    public function create_speaker(motion $motion): \stdClass {
        ...
        $record->id = $DB->insert_record('plenumform_jitsi2_speaker', $record);
